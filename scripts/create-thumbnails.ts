...
function printUsage() {
  ...
  console.log(
    "  bun scripts/create-thumbnails.ts characters/chomb/chombSass.png",
  );
  console.log(
    "  bun scripts/create-thumbnails.ts general/bug.png characters/echo/echo.png",
  );
  console.log("  bun scripts/create-thumbnails.ts public/art/general/bug.png");
  console.log("");
  console.log(
    "Note: Paths can be relative to public/art/ or absolute paths within the project.",
  );
}
