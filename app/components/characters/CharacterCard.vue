...
.character-card {
    ...
    &:hover {
        .character-card__image {
            filter: drop-shadow(0 1px 0 v-bind(characterColor))
                drop-shadow(1px 0 0 v-bind(characterColor))
                drop-shadow(-1px 0 0 v-bind(characterColor))
                drop-shadow(0 -1px 0 v-bind(characterColor))
                drop-shadow(1px 1px 0 v-bind(characterColor))
                drop-shadow(-1px -1px 0 v-bind(characterColor))
                drop-shadow(1px -1px 0 v-bind(characterColor))
                drop-shadow(-1px 1px 0 v-bind(characterColor));
        }
