...
<template>
    <div ref="sketchTextRef" class="sketch-text" v-bind="accessibilityAttrs">
        <!-- Screen reader accessible text -->
        <span v-if="!props.isDecorative" class="sr-only" :id="textId">
            {{ displayText }}
        </span>
...
/* Screen reader only text - now using global .sr-only utility from _reusables.scss */
