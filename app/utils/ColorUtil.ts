...
export function oklchToRgb({ l, c, h }: OKLCHColor): RGBColor {
  ...
  const sRoot = Math.cbrt((L - 0.0894841775 * A - 1.2914855480 * B));
  
  const x = +1.2270138511 * lRoot - 0.5577999807 * mRoot + 0.2812561490 * sRoot;
...
color: string | RGBColor,
  ...
  while (!passesContrast(oklchToRgb(oklch), rgbBgColor, threshold) && iterations < maxIterations) {
