...
export function oklchToRgb({ l, c, h }: OKLCHColor): RGBColor {
    ...
    const x =
        +1.2270138511 * lRoot - 0.5577999807 * mRoot + 0.281256149 * sRoot;
    const y =
        -0.0405801784 * lRoot + 1.1122568696 * mRoot - 0.0716766787 * sRoot;
    const z =
        -0.0763812845 * lRoot - 0.4214819784 * mRoot + 1.5861632204 * sRoot;
