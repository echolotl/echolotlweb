...
export interface paths {
    ...
    "/gridpoints/{wfo}/{x},{y}/stations": {
        parameters: {
            ...
            header?: {
                 ...
                 */
                "Feature-Flags"?: components["parameters"]["ObservationsStationFeatureFlags"];
            };
            path: {
                /** @description Forecast office ID */
                wfo: components["parameters"]["GridpointWFO"];
    ...
    "/points/{latitude},{longitude}/radio": {
        ...
        /** @description Returns NOAA Weather Radio script for a latitude/longitude point */
...
export interface components {
    ...
    parameters: {
         ...
         *     * obs_station_provider: Include the data provider in the metadata about observation stations
         */
        ObservationsStationFeatureFlags: "obs_station_provider"[];
        /** @description Observation station ID */
